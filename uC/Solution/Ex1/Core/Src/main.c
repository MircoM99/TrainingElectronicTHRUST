...
/* USER CODE BEGIN PV */
/*I use the variable in another file so extern must be used*/
extern uint8_t flag;
/*
 * This vector contains the data converted by the ADC and it is automatically
 * filled by the DMA
 */
uint16_t ADCData[5];
/* USER CODE END PV */
...
/*
 * This function is called automatically when the ADC has finished the conversion of the data
 * so here we insert the code to transmit the data to the UART
 */
